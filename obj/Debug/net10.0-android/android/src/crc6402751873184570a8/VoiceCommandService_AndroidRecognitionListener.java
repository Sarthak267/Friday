...
public class VoiceCommandService_AndroidRecognitionListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Friday.VoiceCommandService+AndroidRecognitionListener, Friday", VoiceCommandService_AndroidRecognitionListener.class, __md_methods);
	}

	public VoiceCommandService_AndroidRecognitionListener ()
	{
		super ();
		if (getClass () == VoiceCommandService_AndroidRecognitionListener.class) {
			mono.android.TypeManager.Activate ("Friday.VoiceCommandService+AndroidRecognitionListener, Friday", "", this, new java.lang.Object[] {  });
		}
	}
