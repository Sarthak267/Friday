...
public class FridayVoiceInteractionService_WakePhraseListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Friday.FridayVoiceInteractionService+WakePhraseListener, Friday", FridayVoiceInteractionService_WakePhraseListener.class, __md_methods);
	}

	public FridayVoiceInteractionService_WakePhraseListener ()
	{
		super ();
		if (getClass () == FridayVoiceInteractionService_WakePhraseListener.class) {
			mono.android.TypeManager.Activate ("Friday.FridayVoiceInteractionService+WakePhraseListener, Friday", "", this, new java.lang.Object[] {  });
		}
	}

	public FridayVoiceInteractionService_WakePhraseListener (com.companyname.friday.FridayVoiceInteractionService p0)
	{
		super ();
		if (getClass () == FridayVoiceInteractionService_WakePhraseListener.class) {
			mono.android.TypeManager.Activate ("Friday.FridayVoiceInteractionService+WakePhraseListener, Friday", "Friday.FridayVoiceInteractionService, Friday", this, new java.lang.Object[] { p0 });
		}
	}
